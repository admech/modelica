within Dev.Bodies;
    model BodyDynamics "Rigid body with mass, inertia tensor and one frame connector (12 potential states). WITHOUT VIZUALIZERS"
...
</HTML>"), Icon(coordinateSystem(extent = {{-100,-100},{100,100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2,2}), graphics = {Rectangle(lineColor = {0,24,48}, fillColor = {0,127,255}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-100,30},{-3,-31}}, radius = 10),Text(extent = {{150,-100},{-150,-70}}, textString = "m=%m"),Text(lineColor = {0,0,255}, extent = {{-150,110},{150,70}}, textString = "%name"),Ellipse(origin = {0.566572,-1.13314}, lineColor = {0,24,48}, fillColor = {0,127,255}, fillPattern = FillPattern.Sphere, extent = {{-20,60},{100,-60}}, endAngle = 360)}));
    end BodyDynamics;